...
<@override name="block_main_top"> 
    <div class="main-top paperbg" id="main_top">
      <#include "readover_console.ftl">
       <script type="text/javascript" src="${data.webroot}/static/js/collegeConnection.js"></script>
    </div>    
</@override>
<@override name="block_main_body">  
     <div class="main-body paperbg" id="main_body">
        <div class="paperTitle" id="paperTitle">
            ...
            <span>满s分： <a id="totalScore"> ${data.paper.score}</a> </span>
        </div>
        <!--<#include  "content.ftl" >-->
        <#include  "withoutoption.ftl">
    </div>
</@override>
